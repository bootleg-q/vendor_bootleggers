...
PRODUCT_VERSION_MINOR = niceparse.Starlight
BOOTLEGGERS_VERSION_NUMBER := 5.3-Stable
BOOTLEGGERS_SONGCODEURL = https://cutt.ly/EhkqLEk
...
ifndef BOOTLEGGERS_BUILD_TYPE
    BOOTLEGGERS_BUILD_TYPE := TheRagingBeast
endif
